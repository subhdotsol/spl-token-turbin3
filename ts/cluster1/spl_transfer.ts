...
// Recipient address
const to = new PublicKey("ADm5yXExUnTnrYz1iuNNUZVEg5tiPDcW8nMPQQebPRKt");
...
(async () => {
    try {
        ...
        const tx = await transfer(connection, keypair, fromAta.address, toAta.address, keypair.publicKey, 1000n * 1_000_000n);
